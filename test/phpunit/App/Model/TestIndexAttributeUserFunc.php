 ...
 *
 * Using call_user_func to invoke methods
 *
 * @author davethemac
 */
trait TestIndexAttributeUserFunc {
    ...
    public function getIndexTest($name, $getter = null) {
        ...
        $this->assertSame($this->data[$name], call_user_func([$this->object, $getter]));
    ...
    public function setIndexTest($name, $getter = null, $setter = null) {
        ...
        $this->assertEquals($this->object, call_user_func([$this->object, $setter], $data));
        // test object value
        $this->assertEquals($data, call_user_func([$this->object, $getter]));
    ...
    public function setIntegerTypeErrorTest($parameter, $name, $setter = null) {
        ...
        // set the attribute
        call_user_func([$this->object, $setter], $parameter);
    }
